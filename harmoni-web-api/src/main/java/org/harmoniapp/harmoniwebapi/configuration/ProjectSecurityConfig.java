...
public class ProjectSecurityConfig {
     ...
     * and request authorization based on user roles and custom authorization managers. It also configures
     * which requests are allowed or require authentication.</p>
     *
