...
public record AddressDto(
        ...
        @Pattern(regexp = "^[A-Za-Ā-ɏØ-öø-ÿ'\\-\\s]+$", message = "Miasto musi zawierać tylko litery, spacje, apostrofy i myślniki")
        String city,

        @NotEmpty(message = "Ulica nie może być pusta")
        @Size(max = 100, message = "Ulica musi zawierać mniej niż 100 znaków")
        @Pattern(regexp = "^[A-Za-Ā-ɏØ-öø-ÿ',\\-\\s]+$", message = "Ulica musi zawierać tylko litery, spacje, apostrofy i myślniki")
        String street,
        ...
        @Pattern(regexp = "^[A-Za-zĀ-ɏØ-öø-ÿ'\\-\\s]+$", message = "Nazwa oddziału musi zawierać tylko litery, spacje, apostrofy i myślniki")
