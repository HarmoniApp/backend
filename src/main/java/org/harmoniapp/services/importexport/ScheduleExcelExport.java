...
public class ScheduleExcelExport implements ExportSchedule {
    ...
    public ResponseEntity<InputStreamResource> exportShifts(LocalDate startDate, LocalDate endDate) {
        List<ShiftDto> shifts = getShifts(startDate, endDate);
        List<UserDto> users = getUsers(shifts);
    ...
    /**
     * Retrieves published shifts within a given date range.
     *
     * @param startDate the start date of the range
     * @param endDate the end date of the range
     * @return a list of ShiftDto objects
     */
    private List<ShiftDto> getShifts(LocalDate startDate, LocalDate endDate) {
        return repositoryCollector.getShifts().findAllByDateRangeAndPublishedIsTrue(startDate.atStartOfDay(), endDate.atTime(LocalTime.MAX))
                .stream()
    ...
    /**
     * Retrieves users associated with the given shifts.
     *
     * @param shifts a list of ShiftDto objects
     * @return a list of UserDto objects
     */
    private List<UserDto> getUsers(List<ShiftDto> shifts) {
     ...
     */
    private Map<Long, Map<LocalDate, String>> createUserShiftMap(List<ShiftDto> shifts) {
